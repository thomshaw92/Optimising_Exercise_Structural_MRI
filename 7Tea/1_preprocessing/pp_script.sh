...
export NSLOTS=4
echo $TMPDIR
raw_data_dir=/RDS/Q0530/7Tea/data
...
#$singularity antsRegistrationSyNQuick.sh -t t -d 3 -f $deriv/preprocessing/$subjName/${subjName}_${ss}_T1w_N4corrected_norm_preproc.nii.gz -m $tse1 -o tse1
#$singularity antsRegistrationSyNQuick.sh -t t -d 3 -f $deriv/preprocessing/$subjName/${subjName}_${ss}_T1w_N4corrected_norm_preproc.nii.gz -m $tse2 -o tse2
#$singularity antsRegistrationSyNQuick.sh -t t -d 3 -f $deriv/preprocessing/$subjName/${subjName}_${ss}_T1w_N4corrected_norm_preproc.nii.gz -m $tse3 -o tse3

#tse1=$bidsdir/derivatives/preprocessing/$subjName/tse1Warped.nii.gz
#tse2=$bidsdir/derivatives/preprocessing/$subjName/tse2Warped.nii.gz
#tse3=$bidsdir/derivatives/preprocessing/$subjName/tse3Warped.nii.gz
...
if [[ ! -e  $TMPDIR/derivatives/preprocessing/$subjName/${subjName}_${ss}_T2w_run-${x}_res-iso.3_N4corrected_norm_brain_preproc.nii.gz ]] ; then 
	...
	$singularity fslmaths $deriv/preprocessing/$subjName/${subjName}_${ss}_T2w_run-${x}_res-iso.3_N4corrected_norm_preproc.nii.gz -mul $deriv/preprocessing/$subjName/${subjName}_${ss}_T2w_run-${x}_brainmask.nii.gz $deriv/preprocessing/$subjName/${subjName}_${ss}_T2w_run-${x}_res-iso.3_N4corrected_norm_brain_preproc.nii.gz
$singularity runROBEX.sh $deriv/preprocessing/$subjName/${subjName}_${ss}_T2w_run-${x}_res-iso.3_N4corrected_norm_preproc.nii.gz $deriv/preprocessing/$subjName/${subjName}_${ss}_T2w_run-${x}_res-iso.3_N4corrected_norm_brain_preproc.nii.gz $deriv/preprocessing/$subjName/${subjName}_${ss}_T2w_run-${x}_res-iso.3_N4corrected_norm_brainmask_preproc.nii.gz
...
#just run the stupid thing through robex anyway
	$singularity runROBEX.sh $deriv/preprocessing/$subjName/${subjName}_${ss}_T2w_run-${x}_res-iso.3_N4corrected_norm_preproc.nii.gz $deriv/preprocessing/$subjName/${subjName}_${ss}_T2w_run-${x}_res-iso.3_N4corrected_norm_brain_preproc.nii.gz $deriv/preprocessing/$subjName/${subjName}_${ss}_T2w_run-${x}_res-iso.3_N4corrected_norm_brainmask_preproc.nii.gz
done
