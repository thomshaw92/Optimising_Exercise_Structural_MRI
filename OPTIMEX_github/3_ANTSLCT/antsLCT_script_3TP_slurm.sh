...
#ANTS LCT 3TP
$singularity antsLongitudinalCorticalThickness_noN4.sh -d 3 -e /data/fasttemp/uqtshaw/cai_63_template/cai63_asym_2017_nlin_TempAndPriors/cai63_asym_2017_nlin.nii.gz -m /data/fasttemp/uqtshaw/cai_63_template/cai63_asym_2017_nlin_TempAndPriors/cai63_asym_2017_nlin_ProbabilityMask.nii.gz -p /data/fasttemp/uqtshaw/cai63_asym_2017_nlin_TempAndPriors/prior%d.nii.gz -f /data/fasttemp/uqtshaw/cai_63_template/cai63_asym_2017_nlin_TempAndPriors/cai63_asym_2017_nlin_BrainExtractionMask.nii.gz -t /data/fasttemp/uqtshaw/cai_63_template/cai63_asym_2017_nlin_TempAndPriors/cai63_asym_2017_nlin_Extracted_Brain.nii.gz -o /data/fasttemp/uqtshaw/optimising_exercise/data/derivatives/3_alct/$subjName/${subjName}lct_3_timepoints -k '2' -c '2' -j '16' -r '1' -q '0' -n '1' -b '1' \
