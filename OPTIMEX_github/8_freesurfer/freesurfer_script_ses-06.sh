...
cd $TMPDIR
chmod -R 740 $TMPDIR/
cp /30days/uqtshaw/optimex/bids/${subjName}/ses-02/anat/${subjName}_${ss}*run-1_T1w.nii.gz $TMPDIR/${subjName}_t1w.nii.gz
t1w=/30days/uqtshaw/optimex/bids/${subjName}/ses-02/anat/${subjName}*${ss}_T1w.nii.gz
