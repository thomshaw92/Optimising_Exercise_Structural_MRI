...
export NSLOTS=4
echo $TMPDIR
raw_data_dir=/RDS/Q0535/optimex/data/bids
...
for ss in ses-01 ses-02 ses-03 ses-04 ; do
	...
	$singularity ImageMath 3 ${t1bc} RescaleImage $deriv/preprocessing/$subjName/${subjName}_${ss}_T1w_N4corrected_norm_preproc.nii.gz 0 1000
	...
	for x in "1" "2" "3" ; do
	    ...
	    $singularity $singularity ImageMath 3 $deriv/preprocessing/$subjName/${subjName}_${ss}_T2w_run-${x}_N4corrected_preproc.nii.gz RescaleImage  $deriv/preprocessing/$subjName/${subjName}_${ss}_T2w_run-${x}_N4corrected_norm_preproc.nii.gz 0 1000 
